...
ר' `../../docs/09-COMPUTER-USE-AGENT.md` (סעיף "מגבלות ידועות") ו-`../../docs/02-THREAT-MODEL.md` לפירוט מלא - בתמצית: לא נבדק Windows אמיתי מקצה לקצה מסביבת הפיתוח, אין עדיין שכבת אכיפת-אישור דטרמיניסטית נפרדת מה-AI עצמו, ומנגנון המאקרו (`macros.ts`) קיים אך לא אומת בפועל מול תוכנה אמיתית.
